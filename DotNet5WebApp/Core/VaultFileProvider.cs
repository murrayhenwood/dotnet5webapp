...
namespace DotNet5WebApp.Core
{
    public class VaultFileProvider : IFileProvider
    {
            ...
            string providerPath)
        {
            ...
            MemoryStream = new MemoryStream(System.Text.Encoding.UTF8.GetBytes(secrets.Data.Data.ToString()));
            ...
            string providerPath)
        {
            ...
            MemoryStream = new MemoryStream(System.Text.Encoding.ASCII.GetBytes(secrets.Data.Data.ToString()));
            _fileInfo = new VaultFile(secrets.Data.Data.ToString());
